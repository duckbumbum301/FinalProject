    ...
    def process_order(self):
        ...
        try:
            ...
            if existing_customer:
                ...
                print(f"Updating existing customer: {customer.customer_id}")
            else:
                # Tạo khách hàng mới
                customer = Customer(
                    customer_id=self.data_connector.generate_customer_id(),
                    name=name,
                    phone=phone,
                    email=email,
                    address=address
                )
                print(f"Created new customer with ID: {customer.customer_id}")
            ...
            # Tạo đơn hàng mới
            order = Order(
                order_id="",  # OrderManager sẽ tạo ID
